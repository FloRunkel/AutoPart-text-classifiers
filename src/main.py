...
from gui import GuiMachineLearning
...
if __name__ == "__main__":
        ...
        models = ['xlm-roberta-large'] #['deepset/gbert-large', 'xlm-roberta-large']
        learning_rate_values =  [3e-5] #[1e-05, 2e-5, 3e-5, 4e-4, 4e-5, 4e-6]   
        epochs = 2
        multilabel_selecter= False
        percentual_data_use = 0.5
